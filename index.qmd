...
This deployment worked. Since I hadn't isolated the varibles I removed the `requirements.txt` which resulted in a unsuccessful deployment. Adding the file back resolved the issue.
