...
I tried redeploying the project using `index.qmd` as the entry-point file. The thinking was that since it was defined as a jupyter document and I had now installed jupyter this might make a difference.
